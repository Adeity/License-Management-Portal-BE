...
namespace DP_BE_LicensePortal.Controllers
{
    ...
    public class LicensesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<LicenseOutputDto>>> GetLicensesByOrganization(int organizationId)
        {
            var licenses = await _licenseService.GetByOrganizationIdAsync(organizationId);
            return Ok(licenses);
        }
