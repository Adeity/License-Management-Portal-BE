...
namespace DP_BE_LicensePortal.Migrations
{
    ...
    [Migration("20250307150853_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.ActivationDetail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.ActivationStatusLog", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.AddressType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.ContactType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.InvoiceType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationPackageDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.PackageDetail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.SerialNumberDetail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.SerialNumberRequestLog", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.SubscriptionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.database.User", b =>
                {
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.ActivationDetail", b =>
                {
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.SerialNumberDetail", "SerialNumberDetails")
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.ActivationStatusLog", b =>
                {
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.SerialNumberDetail", "SerialNumberDetail")
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.Invoice", b =>
                {
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.InvoiceType", "InvoiceType")
                        .WithMany("Invoices")
                        .HasForeignKey("InvoiceTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_Invoice_InvoiceType");

                    b.HasOne("DP_BE_LicensePortal.Model.Entities.OrganizationAccount", "OrganizationAccount")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationAccount", b =>
                {
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.OrganizationType", "OrganizationType")
                        .WithMany("OrganizationAccounts")
                        .HasForeignKey("OrganizationTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_OrganizationAccount_OrganizationType");

                    b.HasOne("DP_BE_LicensePortal.Model.Entities.OrganizationAccount", "ParentOrganization")
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationAddress", b =>
                {
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.AddressType", "AddressType")
                        .WithMany("OrganizationAddresses")
                        .HasForeignKey("AddressTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_OrganizationAddress_AddressType");

                    b.HasOne("DP_BE_LicensePortal.Model.Entities.Country", "Country")
                        .WithMany("OrganizationAddresses")
                    ...
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.OrganizationAccount", "OrganizationAccount")
                        ...
                        .HasForeignKey("DP_BE_LicensePortal.Model.Entities.OrganizationAddress", "OrganizationAccountId")
                        .IsRequired()
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationContact", b =>
                {
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.ContactType", "ContactType")
                        .WithMany("OrganizationContacts")
                        .HasForeignKey("ContactTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_OrganizationContact_ContactType");

                    b.HasOne("DP_BE_LicensePortal.Model.database.User", "LoginUser")
                        .WithOne("OrganizationContact")
                        .HasForeignKey("DP_BE_LicensePortal.Model.Entities.OrganizationContact", "LoginUserId")
                    ...
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.OrganizationRole", "OrganizationRole")
                        .WithMany("OrganizationContacts")
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.OrganizationPackageDetail", b =>
                {
                    ...
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.PackageDetail", "PackageDetails")
                        .WithMany("OrganizationPackageDetails")
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.SerialNumberDetail", b =>
                {
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.SerialNumberRequestLog", "SerialNumberRequestLog")
            ...
            modelBuilder.Entity("DP_BE_LicensePortal.Model.Entities.SubscriptionItem", b =>
                {
                    b.HasOne("DP_BE_LicensePortal.Model.Entities.Invoice", "Invoice")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DP_BE_LicensePortal.Model.database.User", null)
                        .WithMany()
